...
import { ThomsonSystem } from './ThomsonSystem';
import { SceneBackdrop } from './SceneBackdrop';

interface ThomsonCanvasProps {
  element: ElementDetails;
}

export function ThomsonCanvas({ element }: ThomsonCanvasProps) {
  const autoRotate = useThomsonStore((state) => state.view.autoRotate);
