...
import { ElementSelector } from '../../../features/chemistry/dalton-model/components/ElementSelector';
import { ElementStats } from '../../../features/chemistry/dalton-model/components/ElementStats';
import { ViewControls } from '../../../features/chemistry/dalton-model/components/ViewControls';
import { DaltonCanvas } from '../../../features/chemistry/dalton-model/visualizer/DaltonCanvas';
import { DEFAULT_ELEMENT, getElementBySymbol } from '../../../data/elements';
import { useDaltonStore } from '../../../features/chemistry/dalton-model/state/useDaltonStore';
import { useTranslation } from '../../../i18n/useTranslation';

export function DaltonModelPage() {
  const selectedSymbol = useDaltonStore((state) => state.selectedSymbol);
  ...
  return (
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">{t('daltonModel.title')}</h2>
        <p className="max-w-3xl text-sm text-muted-foreground sm:text-base">
          {t('daltonModel.subtitle')}
        </p>
      </header>
