export const TRANSLATIONS = {
  en: {
    ...
    'home.start.note': 'Chemistry currently includes the Bohr atom model. Other subjects will appear here as they are built.',
  ...
  tr: {
    ...
    'home.start.note': 'Kimya su anda Bohr atom modelini iceriyor. Diger konular hazirlandikca burada gorunecek.',
