export const TRANSLATIONS = {
  en: {
    ...
    'tools.stepConverter.panel.description':
      'Upload a STEP/IGES file and choose an output format.',
    ...
    'tools.stepConverter.status.missingFile': 'Select a STEP or IGES file first.',
    'tools.stepConverter.status.invalidNumbers': 'Deflection values must be numbers.',
    'tools.stepConverter.notes.title': 'Notes',
    'tools.stepConverter.notes.item1': 'Large models can take a few minutes.',
    'tools.stepConverter.notes.item2': 'Outputs are generated by the OCCT API service.',
    'tools.stepConverter.notes.item3':
      'Keep files under a few hundred MB for best results.',
  ...
  tr: {
    ...
    'tools.stepConverter.panel.description':
      'STEP/IGES dosyası yükleyin ve çıktı formatını seçin.',
    'tools.stepConverter.form.fileLabel': 'Girdi dosyası',
    'tools.stepConverter.form.fileHint': 'Kabul edilen: .step, .stp, .iges, .igs',
    ...
    'tools.stepConverter.status.missingFile': 'Önce bir STEP veya IGES dosyası seçin.',
    'tools.stepConverter.status.invalidNumbers': 'Sapma değerleri sayı olmalı.',
    'tools.stepConverter.notes.title': 'Notlar',
    'tools.stepConverter.notes.item1': 'Büyük modeller birkaç dakika sürebilir.',
    'tools.stepConverter.notes.item2': 'Çıktılar OCCT API servisi tarafından üretilir.',
    'tools.stepConverter.notes.item3':
      'En iyi sonuç için dosyaları yüzlerce MB altında tutun.',
