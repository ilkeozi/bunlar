...
class RawWebDiscoveryEvent(Base):
    __tablename__ = "raw_web_discovery_event"
    ...
    __table_args__ = (
        Index("ix_raw_web_discovery_event_orch_id", "orchestration_id", "id"),
        Index("ix_raw_web_discovery_event_batch_id", "ingest_batch_id", "id"),
    )
