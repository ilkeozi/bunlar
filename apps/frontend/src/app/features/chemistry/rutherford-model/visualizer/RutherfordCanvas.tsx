...
import { RutherfordSystem } from './RutherfordSystem';
import { SceneBackdrop } from './SceneBackdrop';

interface RutherfordCanvasProps {
  element: ElementDetails;
}

export function RutherfordCanvas({ element }: RutherfordCanvasProps) {
  const autoRotate = useRutherfordStore((state) => state.view.autoRotate);
    ...
    <div className="absolute inset-0">
      ...
      >
        ...
        <Suspense fallback={null}>
          <SceneBackdrop />
          <RutherfordSystem element={element} />
